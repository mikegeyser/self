...
if(supportsAdoptingStyleSheets){this._styleSheet=new CSSStyleSheet;this._styleSheet.replaceSync(this.cssText)}else{this._styleSheet=null}}return this._styleSheet}toString(){return this.cssText}}/**
   ...
   */const unsafeCSS=value=>{return new CSSResult(value+"",constructionToken)},textFromCSSResult=value=>{if(value instanceof CSSResult){return value.cssText}else{throw new Error(`Value passed to 'css' function must be a 'css' function result: ${value}. Use 'unsafeCSS' to pass non-literal values, but
...
`;var sharedStyles={SharedStyles:SharedStyles};const INITIAL_STATE={page:"",offline:!1,drawerOpened:!1,snackbarOpened:!1},app$1=(state=INITIAL_STATE,action)=>{switch(action.type){case UPDATE_PAGE:return{...state,page:action.page,routeData:action.routeData};case UPDATE_OFFLINE:return{...state,offline:action.offline};case UPDATE_DRAWER_STATE:return{...state,drawerOpened:action.opened};case OPEN_SNACKBAR:return{...state,snackbarOpened:!0};case CLOSE_SNACKBAR:return{...state,snackbarOpened:!1};default:return state;}};var app$2={default:app$1};const INITIAL_STATE$1={articles:[],talks:[],markdown:""},content=(state=INITIAL_STATE$1,action)=>{switch(action.type){case CONTENT_RECEIVED:return{...state,...action.content};case MARKDOWN_RECEIVED:return{...state,markdown:action.markdown};default:return state;}};var content_reducer={content:content};// See https://github.com/zalmoxisus/redux-devtools-extension for more information.
...
shouldUpdate(){return this.active}static get properties(){return{active:{type:Boolean}}}}var pageViewElement={PageViewElement:PageViewElement};export{app as $app,app$2 as $app$1,app$1 as $appDefault,appLayoutBehavior as $appLayoutBehavior,appScrollEffectsBehavior as $appScrollEffectsBehavior,applyShim as $applyShim$1,ApplyShim as $applyShimDefault,applyShimUtils as $applyShimUtils,arraySelector as $arraySelector,arraySplice as $arraySplice,async as $async,caseMap$1 as $caseMap,_class as $class,commonRegex as $commonRegex,commonUtils as $commonUtils,connectMixin as $connectMixin,contentReceived_action as $contentReceivedAction,content_reducer as $contentReducer,content_service as $contentService,cssParse as $cssParse,cssTag as $cssTag,customStyle as $customStyle,customStyleInterface as $customStyleInterface$1,CustomStyleInterface as $customStyleInterfaceDefault,debounce as $debounce,decorators as $decorators,defaultTemplateProcessor$1 as $defaultTemplateProcessor,dirMixin as $dirMixin,directive$1 as $directive,documentWait$1 as $documentWait,documentWait as $documentWaitDefault,dom$1 as $dom,domBind as $domBind,domIf as $domIf,domModule as $domModule,domRepeat as $domRepeat,elementMixin as $elementMixin,flattenedNodesObserver as $flattenedNodesObserver,flush$2 as $flush,gestureEventListeners as $gestureEventListeners,gestures$1 as $gestures,helpers as $helpers,htmlTag as $htmlTag,index as $index,index$1 as $index$1,thunk as $indexDefault,result as $indexDefault$1,ironResizableBehavior as $ironResizableBehavior,ironScrollTargetBehavior as $ironScrollTargetBehavior,lazyReducerEnhancer$1 as $lazyReducerEnhancer,legacyElementMixin as $legacyElementMixin,litElement as $litElement,litHtml as $litHtml,markdownReceived_action as $markdownReceivedAction,mediaQuery as $mediaQuery,metadata as $metadata,mixin as $mixin,modifyTemplate as $modifyTemplate,mutableData as $mutableData,mutableDataBehavior as $mutableDataBehavior,myIcons as $myIcons,network as $network,pageViewElement as $pageViewElement,part as $part,parts as $parts,path as $path,polymer_dom as $polymerDom,polymerElement as $polymerElement,polymerFn as $polymerFn,polymerLegacy as $polymerLegacy,ponyfill as $ponyfill,symbolObservablePonyfill as $ponyfillDefault,propertiesChanged as $propertiesChanged,propertiesMixin as $propertiesMixin,propertyAccessors as $propertyAccessors,propertyEffects as $propertyEffects,redux as $redux,render$1 as $render,renderStatus as $renderStatus,resolveUrl$1 as $resolveUrl,router as $router,settings as $settings,shadyRender as $shadyRender,sharedStyles as $sharedStyles,store$1 as $store,styleGather as $styleGather,styleSettings as $styleSettings,styleUtil as $styleUtil,template$1 as $template,templateFactory$1 as $templateFactory,templateInstance as $templateInstance,templateMap$1 as $templateMap,templateMap as $templateMapDefault,templateResult as $templateResult,templateStamp as $templateStamp,templatize$1 as $templatize,templatizerBehavior as $templatizerBehavior,unscopedStyleHandler as $unscopedStyleHandler,updatingElement as $updatingElement,ANIMATION_MATCH,AppLayoutBehavior,AppScrollEffectsBehavior,ArraySelector,ArraySelectorMixin,AttributeCommitter,AttributeCommitter as AttributeCommitter$1,AttributePart,AttributePart as AttributePart$1,BRACKETED,Base,BooleanAttributePart,BooleanAttributePart as BooleanAttributePart$1,CLOSE_SNACKBAR,CONTENT_RECEIVED,CSSResult,CSSResult as CSSResult$1,Class,CustomStyle,CustomStyleInterfaceInterface,CustomStyleProvider,Debouncer,DefaultTemplateProcessor,DefaultTemplateProcessor as DefaultTemplateProcessor$1,DirMixin,DomApi,DomBind,DomIf,DomModule,DomRepeat,ElementMixin,EventApi,EventPart,EventPart as EventPart$1,FlattenedNodesObserver,GestureEventListeners,HOST_PREFIX,HOST_SUFFIX,IS_VAR,IronResizableBehavior,IronScrollTargetBehavior,LegacyElementMixin,LitElement,MARKDOWN_RECEIVED,MEDIA_MATCH,MIXIN_MATCH,MutableData,MutableDataBehavior,NodePart,NodePart as NodePart$1,OPEN_SNACKBAR,OptionalMutableData,OptionalMutableDataBehavior,PageViewElement,Polymer,Polymer as Polymer$1,PolymerElement,PropertiesChanged,PropertiesMixin,PropertyAccessors,PropertyCommitter,PropertyCommitter as PropertyCommitter$1,PropertyEffects,PropertyPart,PropertyPart as PropertyPart$1,SVGTemplateResult,SVGTemplateResult as SVGTemplateResult$1,SVGTemplateResult as SVGTemplateResult$2,SharedStyles,StyleNode,Template,Template as Template$1,TemplateInstance,TemplateInstance as TemplateInstance$1,TemplateInstanceBase,TemplateResult,TemplateResult as TemplateResult$1,TemplateResult as TemplateResult$2,TemplateResult as TemplateResult$3,TemplateStamp,Templatizer,UPDATE_DRAWER_STATE,UPDATE_OFFLINE,UPDATE_PAGE,UpdatingElement,UpdatingElement as UpdatingElement$1,VAR_ASSIGN,VAR_CONSUMED,ActionTypes as __DO_NOT_USE__ActionTypes,_scrollEffects,_scrollTimer,add,enqueueDebouncer as addDebouncer,addListener,addToCartIcon,afterNextRender,allowTemplateFromDomModule,animationFrame,applyCss,applyMiddleware,applyStyle,applyStylePlaceHolder,beforeNextRender,bindActionCreators,boundAttributeSuffix,calculateSplices,camelToDashCase,combineReducers,compose,connect,content,contentReceived,createMarker,createMarker as createMarker$1,createScopeStyle,createStore,css,css as css$1,cssBuild,cssFromModule,cssFromModuleImports,cssFromModules,cssFromTemplate,customElement,customElement as customElement$1,dashToCamelCase,dedupingMixin,deepTargetFind,defaultConverter,defaultConverter as defaultConverter$1,defaultTemplateProcessor,defaultTemplateProcessor as defaultTemplateProcessor$1,detectMixin,directive,directive as directive$1,dom,dumpRegistrations,elementHasBuiltCss,elementsAreInvalid,enqueueDebouncer,eventOptions,eventOptions as eventOptions$1,findMatchingParen,findOriginalTarget,flush$1 as flush,flush$1,flush as flush$2,forEachRule,gatherStyleText,gestures,get,getBuildComment,getComputedStyleValue,getContent,getCssBuild,getIsExtends,getMarkdown,html$1 as html,html as html$1,html as html$2,html as html$3,html$1 as html$4,html$1 as html$5,htmlLiteral,idlePeriod,insertNodeIntoTemplate,installMediaQueryWatcher,installOfflineWatcher,installRouter,instanceCount,invalidate,invalidateTemplate,isAncestor,isCEPolyfill,isDeep,isDescendant,isDirective,isDirective as isDirective$1,isIterable,isIterable as isIterable$1,isKeyframesSelector,isOptimalCssBuild,isPath,isPrimitive,isPrimitive as isPrimitive$1,isTargetedBuild,isTemplatePartActive,isTemplatePartActive as isTemplatePartActive$1,isUnscopedStyle,isValid,isValidating,lastAttributeNameRegex,lazyReducerEnhancer,markdownReceived,marker,markerRegex,matches,matchesSelector,menuIcon,microTask,minusIcon,mixinBehaviors,modelForElement,nativeCssVariables,nativeShadow,navigate,noChange,noChange as noChange$1,nodeMarker,normalize,notEqual,notEqual as notEqual$1,nothing,nothing as nothing$1,parse,parts$1 as parts,parts$1,passiveTouchGestures,pathFromUrl,plusIcon,prevent,processUnscopedStyle,processVariableAndFallback,property,property as property$1,query,query as query$1,queryAll,queryAll as queryAll$1,queryAllRoot,recognizers,register,register$1,registerEffect,registrations,remove,removeCustomPropAssignment,removeFromCartIcon,removeListener,removeNodes,removeNodes as removeNodes$1,removeNodesFromTemplate,render,render$2 as render$1,render as render$2,reparentNodes,reparentNodes as reparentNodes$1,resetMouseCanceller,resolveCss,resolveUrl,root,rootPath,rulesForStyle,sanitizeDOMValue,scopingAttribute,scroll,scrollTimingFunction,set,setAllowTemplateFromDomModule,setElementClassRaw,setPassiveTouchGestures,setRootPath,setSanitizeDOMValue,setStrictTemplatePolicy,setTouchAction,showSnackbar,split,splitSelectorList,startValidating,startValidatingTemplate,store,strictTemplatePolicy,stringify,stylesFromModule,stylesFromModuleImports,stylesFromModules,stylesFromTemplate,supportsAdoptingStyleSheets,supportsAdoptingStyleSheets as supportsAdoptingStyleSheets$1,svg,svg as svg$1,svg as svg$2,templateCaches,templateCaches as templateCaches$1,templateFactory,templateFactory as templateFactory$1,templateIsValid,templateIsValidating,templatize,timeOut,toCssText,translate,types,unsafeCSS,unsafeCSS as unsafeCSS$1,updateDrawerState,updateMetadata,updateNativeProperties,updateOffline,updateStyles,useNativeCSSProperties,useNativeCustomElements,useShadow,version,version as version$1,wrap};