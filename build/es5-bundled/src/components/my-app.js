...
*/"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.$documentWaitDefault=documentWait;_exports.$ponyfillDefault=symbolObservablePonyfill;_exports.addListener=addListener;_exports.afterNextRender=afterNextRender;_exports.applyCss=applyCss;_exports.applyMiddleware=applyMiddleware;_exports.applyStyle=applyStyle;_exports.applyStylePlaceHolder=applyStylePlaceHolder;_exports.beforeNextRender=beforeNextRender;_exports.bindActionCreators=bindActionCreators;_exports.calculateSplices=calculateSplices;_exports.camelToDashCase=camelToDashCase;_exports.combineReducers=combineReducers;_exports.compose=compose;_exports.createScopeStyle=createScopeStyle;_exports.createStore=createStore;_exports.cssFromModule=cssFromModule;_exports.cssFromModuleImports=cssFromModuleImports;_exports.cssFromModules=cssFromModules;_exports.cssFromTemplate=cssFromTemplate;_exports.dashToCamelCase=dashToCamelCase;_exports.deepTargetFind=deepTargetFind;_exports.detectMixin=_detectMixin;_exports.dumpRegistrations=dumpRegistrations;_exports.elementHasBuiltCss=elementHasBuiltCss;_exports.elementsAreInvalid=elementsAreInvalid;_exports.findMatchingParen=findMatchingParen;_exports.flush$2=flush;_exports.forEachRule=forEachRule;_exports.gatherStyleText=gatherStyleText;_exports.get=_get;_exports.getBuildComment=getBuildComment;_exports.getComputedStyleValue=_getComputedStyleValue;_exports.getCssBuild=getCssBuild;_exports.getIsExtends=getIsExtends;_exports.insertNodeIntoTemplate=insertNodeIntoTemplate;_exports.invalidate=invalidate;_exports.invalidateTemplate=invalidateTemplate;_exports.isAncestor=isAncestor;_exports.isDescendant=isDescendant;_exports.isKeyframesSelector=isKeyframesSelector;_exports.isOptimalCssBuild=isOptimalCssBuild;_exports.isPath=isPath;_exports.isTargetedBuild=isTargetedBuild;_exports.isUnscopedStyle=isUnscopedStyle;_exports.isValid=isValid;_exports.isValidating=isValidating;_exports.matches=matches;_exports.mixinBehaviors=mixinBehaviors;_exports.modelForElement=_modelForElement;_exports.normalize=normalize;_exports.parse=parse;_exports.pathFromUrl=pathFromUrl;_exports.prevent=_prevent;_exports.processUnscopedStyle=processUnscopedStyle;_exports.processVariableAndFallback=processVariableAndFallback;_exports.property$1=_exports.property=property;_exports.query$1=_exports.query=query;_exports.queryAll$1=_exports.queryAll=queryAll;_exports.register=register;_exports.register$1=register$1;_exports.removeCustomPropAssignment=removeCustomPropAssignment;_exports.removeListener=removeListener;_exports.removeNodesFromTemplate=removeNodesFromTemplate;_exports.resetMouseCanceller=resetMouseCanceller;_exports.resolveCss=resolveCss;_exports.resolveUrl=_resolveUrl;_exports.root=root;_exports.rulesForStyle=rulesForStyle;_exports.set=_set;_exports.setElementClassRaw=setElementClassRaw;_exports.setTouchAction=setTouchAction;_exports.split=split;_exports.splitSelectorList=splitSelectorList;_exports.startValidating=startValidating;_exports.startValidatingTemplate=startValidatingTemplate;_exports.stringify=stringify;_exports.stylesFromModule=stylesFromModule;_exports.stylesFromModuleImports=stylesFromModuleImports;_exports.stylesFromModules=stylesFromModules;_exports.stylesFromTemplate=stylesFromTemplate;_exports.templateFactory$1=_exports.templateFactory=templateFactory;_exports.templateIsValid=templateIsValid;_exports.templateIsValidating=templateIsValidating;_exports.templatize=_templatize;_exports.toCssText=toCssText;_exports.translate=translate;_exports.updateNativeProperties=updateNativeProperties;_exports.AppScrollEffectsBehavior=_exports.AppLayoutBehavior=_exports.ANIMATION_MATCH=_exports.$updatingElement=_exports.$unscopedStyleHandler=_exports.$templatizerBehavior=_exports.$templatize=_exports.$templateStamp=_exports.$templateResult=_exports.$templateMapDefault=_exports.$templateMap=_exports.$templateInstance=_exports.$templateFactory=_exports.$template=_exports.$styleUtil=_exports.$styleSettings=_exports.$styleGather=_exports.$store=_exports.$sharedStyles=_exports.$shadyRender=_exports.$settings=_exports.$router=_exports.$resolveUrl=_exports.$renderStatus=_exports.$render=_exports.$redux=_exports.$propertyEffects=_exports.$propertyAccessors=_exports.$propertiesMixin=_exports.$propertiesChanged=_exports.$ponyfill=_exports.$polymerLegacy=_exports.$polymerFn=_exports.$polymerElement=_exports.$polymerDom=_exports.$path=_exports.$parts=_exports.$part=_exports.$pageViewElement=_exports.$network=_exports.$myIcons=_exports.$mutableDataBehavior=_exports.$mutableData=_exports.$modifyTemplate=_exports.$mixin=_exports.$metadata=_exports.$mediaQuery=_exports.$markdownReceivedAction=_exports.$litHtml=_exports.$litElement=_exports.$legacyElementMixin=_exports.$lazyReducerEnhancer=_exports.$ironScrollTargetBehavior=_exports.$ironResizableBehavior=_exports.$indexDefault$1=_exports.$indexDefault=_exports.$index$1=_exports.$index=_exports.$htmlTag=_exports.$helpers=_exports.$gestures=_exports.$gestureEventListeners=_exports.$flush=_exports.$flattenedNodesObserver=_exports.$elementMixin=_exports.$domRepeat=_exports.$domModule=_exports.$domIf=_exports.$domBind=_exports.$dom=_exports.$documentWait=_exports.$directive=_exports.$dirMixin=_exports.$defaultTemplateProcessor=_exports.$decorators=_exports.$debounce=_exports.$customStyleInterfaceDefault=_exports.$customStyleInterface$1=_exports.$customStyle=_exports.$cssTag=_exports.$cssParse=_exports.$contentService=_exports.$contentReducer=_exports.$contentReceivedAction=_exports.$connectMixin=_exports.$commonUtils=_exports.$commonRegex=_exports.$class=_exports.$caseMap=_exports.$async=_exports.$arraySplice=_exports.$arraySelector=_exports.$applyShimUtils=_exports.$applyShimDefault=_exports.$applyShim$1=_exports.$appScrollEffectsBehavior=_exports.$appLayoutBehavior=_exports.$appDefault=_exports.$app$1=_exports.$app=void 0;_exports.createMarker$1=_exports.createMarker=_exports.contentReceived=_exports.content=_exports.connect=_exports.boundAttributeSuffix=_exports.animationFrame=_exports.allowTemplateFromDomModule=_exports.addToCartIcon=_exports.enqueueDebouncer=_exports.addDebouncer=_exports.add=_exports._scrollTimer=_exports._scrollEffects=_exports.__DO_NOT_USE__ActionTypes=_exports.VAR_CONSUMED=_exports.VAR_ASSIGN=_exports.UpdatingElement$1=_exports.UpdatingElement=_exports.UPDATE_PAGE=_exports.UPDATE_OFFLINE=_exports.UPDATE_DRAWER_STATE=_exports.Templatizer=_exports.TemplateStamp=_exports.TemplateResult$3=_exports.TemplateResult$2=_exports.TemplateResult$1=_exports.TemplateResult=_exports.TemplateInstanceBase=_exports.TemplateInstance$1=_exports.TemplateInstance=_exports.Template$1=_exports.Template=_exports.StyleNode=_exports.SharedStyles=_exports.SVGTemplateResult$2=_exports.SVGTemplateResult$1=_exports.SVGTemplateResult=_exports.PropertyPart$1=_exports.PropertyPart=_exports.PropertyEffects=_exports.PropertyCommitter$1=_exports.PropertyCommitter=_exports.PropertyAccessors=_exports.PropertiesMixin=_exports.PropertiesChanged=_exports.PolymerElement=_exports.Polymer$1=_exports.Polymer=_exports.PageViewElement=_exports.OptionalMutableDataBehavior=_exports.OptionalMutableData=_exports.OPEN_SNACKBAR=_exports.NodePart$1=_exports.NodePart=_exports.MutableDataBehavior=_exports.MutableData=_exports.MIXIN_MATCH=_exports.MEDIA_MATCH=_exports.MARKDOWN_RECEIVED=_exports.LitElement=_exports.LegacyElementMixin=_exports.IronScrollTargetBehavior=_exports.IronResizableBehavior=_exports.IS_VAR=_exports.HOST_SUFFIX=_exports.HOST_PREFIX=_exports.GestureEventListeners=_exports.FlattenedNodesObserver=_exports.EventPart$1=_exports.EventPart=_exports.EventApi=_exports.ElementMixin=_exports.DomRepeat=_exports.DomModule=_exports.DomIf=_exports.DomBind=_exports.DomApi=_exports.DirMixin=_exports.DefaultTemplateProcessor$1=_exports.DefaultTemplateProcessor=_exports.Debouncer=_exports.CustomStyleProvider=_exports.CustomStyleInterfaceInterface=_exports.CustomStyle=_exports.Class=_exports.CSSResult$1=_exports.CSSResult=_exports.CONTENT_RECEIVED=_exports.CLOSE_SNACKBAR=_exports.BooleanAttributePart$1=_exports.BooleanAttributePart=_exports.Base=_exports.BRACKETED=_exports.AttributePart$1=_exports.AttributePart=_exports.AttributeCommitter$1=_exports.AttributeCommitter=_exports.ArraySelectorMixin=_exports.ArraySelector=void 0;_exports.timeOut=_exports.templateCaches$1=_exports.templateCaches=_exports.svg$2=_exports.svg$1=_exports.svg=_exports.supportsAdoptingStyleSheets$1=_exports.supportsAdoptingStyleSheets=_exports.strictTemplatePolicy=_exports.store=_exports.showSnackbar=_exports.setStrictTemplatePolicy=_exports.setSanitizeDOMValue=_exports.setRootPath=_exports.setPassiveTouchGestures=_exports.setAllowTemplateFromDomModule=_exports.scrollTimingFunction=_exports.scroll=_exports.scopingAttribute=_exports.sanitizeDOMValue=_exports.rootPath=_exports.reparentNodes$1=_exports.reparentNodes=_exports.render$1=_exports.render$2=_exports.render=_exports.removeNodes$1=_exports.removeNodes=_exports.removeFromCartIcon=_exports.remove=_exports.registrations=_exports.registerEffect=_exports.recognizers=_exports.queryAllRoot=_exports.plusIcon=_exports.passiveTouchGestures=_exports.parts$1=_exports.parts=_exports.nothing$1=_exports.nothing=_exports.notEqual$1=_exports.notEqual=_exports.nodeMarker=_exports.noChange$1=_exports.noChange=_exports.navigate=_exports.nativeShadow=_exports.nativeCssVariables=_exports.minusIcon=_exports.microTask=_exports.menuIcon=_exports.matchesSelector=_exports.markerRegex=_exports.marker=_exports.markdownReceived=_exports.lazyReducerEnhancer=_exports.lastAttributeNameRegex=_exports.isTemplatePartActive$1=_exports.isTemplatePartActive=_exports.isPrimitive$1=_exports.isPrimitive=_exports.isIterable$1=_exports.isIterable=_exports.isDirective$1=_exports.isDirective=_exports.isDeep=_exports.isCEPolyfill=_exports.instanceCount=_exports.installRouter=_exports.installOfflineWatcher=_exports.installMediaQueryWatcher=_exports.idlePeriod=_exports.htmlLiteral=_exports.html$3=_exports.html$2=_exports.html$1=_exports.html$5=_exports.html$4=_exports.html=_exports.getMarkdown=_exports.getContent=_exports.gestures=_exports.flush$1=_exports.flush=_exports.findOriginalTarget=_exports.eventOptions$1=_exports.eventOptions=_exports.dom=_exports.directive$1=_exports.directive=_exports.defaultTemplateProcessor$1=_exports.defaultTemplateProcessor=_exports.defaultConverter$1=_exports.defaultConverter=_exports.dedupingMixin=_exports.customElement$1=_exports.customElement=_exports.cssBuild=_exports.css$1=_exports.css=void 0;_exports.wrap=_exports.version$1=_exports.version=_exports.useShadow=_exports.useNativeCustomElements=_exports.useNativeCSSProperties=_exports.updateStyles=_exports.updateOffline=_exports.updateMetadata=_exports.updateDrawerState=_exports.unsafeCSS$1=_exports.unsafeCSS=_exports.types=void 0;meta=babelHelpers.interopRequireWildcard(meta);_require=babelHelpers.interopRequireWildcard(_require);function _templateObject21_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          width: 100%;\n\n          --app-max-width: 1000px;\n          --app-drawer-width: 256px;\n\n          /*--app-primary-color: #e91e63;*/\n          --app-primary-color: #293237;\n          --app-secondary-color: #293237;\n          --app-secondary-color: #293237;\n          --app-dark-text-color: var(--app-secondary-color);\n          --app-light-text-color: white;\n          --app-section-even-color: #f7f7f7;\n          --app-section-odd-color: white;\n          --app-heading-font: 'Indie Flower', sans-serif;\n\n          --app-header-background-color: white;\n          --app-header-text-color: var(--app-dark-text-color);\n          --app-header-selected-color: var(--app-primary-color);\n\n          --app-drawer-background-color: var(--app-secondary-color);\n          --app-drawer-text-color: var(--app-light-text-color);\n          --app-drawer-selected-color: #78909c;\n        }\n\n        app-header {\n          position: fixed;\n          top: 0;\n          left: 0;\n          width: 100%;\n          text-align: center;\n          background-color: var(--app-header-background-color);\n          color: var(--app-header-text-color);\n          border-bottom: 1px solid #eee;\n        }\n\n        .toolbar-top {\n          background-color: var(--app-header-background-color);\n        }\n\n        [main-title],\n        h1 {\n          font-family: var(--app-heading-font);\n          text-transform: lowercase;\n          font-size: 30px;\n          /* In the narrow layout, the toolbar is offset by the width of the\n          drawer button, and the text looks not centered. Add a padding to\n          match that button */\n          padding-right: 44px;\n        }\n\n        .toolbar-list {\n          display: none;\n        }\n\n        .toolbar-list > a {\n          display: inline-block;\n          color: var(--app-header-text-color);\n          text-decoration: none;\n          line-height: 30px;\n          padding: 4px 24px;\n        }\n\n        .toolbar-list > a[selected] {\n          color: var(--app-header-selected-color);\n          border-bottom: 4px solid var(--app-header-selected-color);\n        }\n\n        .menu-btn {\n          background: none;\n          border: none;\n          fill: var(--app-header-text-color);\n          cursor: pointer;\n          height: 44px;\n          width: 44px;\n        }\n\n        .drawer-list {\n          box-sizing: border-box;\n          width: 100%;\n          height: 100%;\n          padding: 24px;\n          background: var(--app-drawer-background-color);\n          position: relative;\n        }\n\n        .drawer-list > a {\n          display: block;\n          text-decoration: none;\n          color: var(--app-drawer-text-color);\n          line-height: 40px;\n          padding: 0 24px;\n        }\n\n        .drawer-list > a[selected] {\n          color: var(--app-drawer-selected-color);\n        }\n\n        /* Workaround for IE11 displaying <main> as inline */\n        main {\n          display: block;\n        }\n\n        .main-content {\n          min-height: 100vh;\n        }\n\n        .page {\n          display: none;\n        }\n\n        .page[active] {\n          display: block;\n        }\n\n        footer {\n          padding: 24px;\n          background: var(--app-drawer-background-color);\n          color: var(--app-drawer-text-color);\n          text-align: center;\n        }\n\n        /* Wide layout: when the viewport width is bigger than 460px, layout\n        changes to a wide layout */\n        @media (min-width: 460px) {\n          .toolbar-list {\n            display: block;\n          }\n\n          .menu-btn {\n            display: none;\n          }\n\n          .main-content {\n          }\n\n          /* The drawer button isn't shown in the wide layout, so we don't\n          need to offset the title */\n          [main-title] {\n            padding-right: 0px;\n          }\n        }\n      "]);_templateObject21_27d9fd20813811e99f94edb206e3123b=function _templateObject21_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject20_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n      <m-menu-bar></m-menu-bar>\n\n      <!-- Main content -->\n      <main role=\"main\" class=\"main-content\">\n        ","\n      </main>\n\n      <footer>\n        <p>\n          The content on this site is published under the\n          <a href=\"https://creativecommons.org/licenses/by-nc-sa/4.0/\">Creative Commons CC BY-NC-SA 4.0 license.</a>\n        </p>\n      </footer>\n\n      <snack-bar ?active=\"","\">\n        You are now ",".\n      </snack-bar>\n    "]);_templateObject20_27d9fd20813811e99f94edb206e3123b=function _templateObject20_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject19_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n          <my-view404 class=\"page\" active></my-view404>\n        "]);_templateObject19_27d9fd20813811e99f94edb206e3123b=function _templateObject19_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject18_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n          <m-videos class=\"page\" active></m-videos>\n        "]);_templateObject18_27d9fd20813811e99f94edb206e3123b=function _templateObject18_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject17_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n          <m-article class=\"page\" active></m-article>\n        "]);_templateObject17_27d9fd20813811e99f94edb206e3123b=function _templateObject17_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject16_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n          <m-articles class=\"page\" active></m-article>\n        "]);_templateObject16_27d9fd20813811e99f94edb206e3123b=function _templateObject16_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject15_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n          <m-home class=\"page\" active></m-home>\n        "]);_templateObject15_27d9fd20813811e99f94edb206e3123b=function _templateObject15_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject14_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          position: fixed;\n          top: 100%;\n          left: 0;\n          right: 0;\n          padding: 12px;\n          background-color: var(--app-secondary-color);\n          color: white;\n          box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);\n          text-align: center;\n          will-change: transform;\n          transform: translate3d(0, 0, 0);\n          transition-property: visibility, transform;\n          transition-duration: 0.2s;\n          visibility: hidden;\n        }\n\n        :host([active]) {\n          visibility: visible;\n          transform: translate3d(0, -100%, 0);\n        }\n\n        @media (min-width: 460px) {\n          :host {\n            width: 320px;\n            margin: auto;\n          }\n        }\n      "]);_templateObject14_27d9fd20813811e99f94edb206e3123b=function _templateObject14_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject13_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n    "]);_templateObject13_27d9fd20813811e99f94edb206e3123b=function _templateObject13_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject12_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n      <app-header condenses reveals effects=\"waterfall\">\n        <div main-title>\n          <h2>\n            <a href=\"/\">\n              // mikerambl.es\n            </a>\n          </h2>\n          <nav class=\"toolbar-list\">\n            <a ?selected=\"","\" href=\"/\">Home</a>\n            <a ?selected=\"","\" href=\"/articles\">Articles</a>\n            <a ?selected=\"","\" href=\"/videos\">Videos</a>\n          </nav>\n          <button class=\"menu-btn\" title=\"Menu\" @click=\"","\">","</button>\n        </div>\n      </app-header>\n\n      <app-drawer .opened=\"","\" @opened-changed=\"","\">\n        <nav class=\"drawer-list\">\n          <a ?selected=\"","\" href=\"/\">Home</a>\n          <a ?selected=\"","\" href=\"/articles\">Articles</a>\n          <a ?selected=\"","\" href=\"/videos\">Videos</a>\n        </nav>\n      </app-drawer>\n    "]);_templateObject12_27d9fd20813811e99f94edb206e3123b=function _templateObject12_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject11_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n  app-header {\n    width: 100%;\n    text-align: center;\n    background-color: var(--app-header-background-color);\n    color: var(--app-header-text-color);\n    border-bottom: 1px solid #eee;\n    padding: 0.5em 0;\n  }\n\n  [main-title] {\n    margin: auto;\n    display: flex;\n    pointer-events: auto;\n    line-height: 2.65em;\n  }\n\n  h2 {\n    font-family: var(--app-heading-font);\n    flex: 1 1 auto;\n    text-align: center;\n    margin: 0;\n    padding: 0.1em;\n  }\n\n  app-toolbar {\n    line-height: 2.65em;\n    margin: auto;\n    flex: 0 1 auto;\n    display: inline-flex;\n    flex-direction: row;\n    flex-basis: auto;\n  }\n\n  nav.toolbar-list {\n    margin-right: 1em;\n    display: flex;\n    justify-content: flex-end;\n    margin-top: 0.5em;\n  }\n\n  .toolbar-top {\n    background-color: var(--app-header-background-color);\n  }\n\n  a,\n  a:active,\n  a:visited {\n    text-decoration: none;\n    color: var(--app-header-text-color);\n  }\n\n  nav.toolbar-list {\n    display: none;\n  }\n\n  .toolbar-list > a {\n    display: inline-block;\n    color: var(--app-header-text-color);\n    text-decoration: none;\n    line-height: 30px;\n    padding: 4px 24px;\n  }\n\n  .toolbar-list > a[selected] {\n    color: var(--app-header-selected-color);\n    font-weight: bold;\n  }\n\n  .menu-btn {\n    background: none;\n    border: none;\n    fill: var(--app-header-text-color);\n    cursor: pointer;\n    height: 44px;\n    width: 44px;\n  }\n\n  .drawer-list {\n    box-sizing: border-box;\n    width: 100%;\n    height: 100%;\n    padding: 24px;\n    background: var(--app-drawer-background-color);\n    position: relative;\n  }\n\n  .drawer-list > a {\n    display: block;\n    text-decoration: none;\n    color: var(--app-drawer-text-color);\n    line-height: 40px;\n    padding: 0 24px;\n  }\n\n  .drawer-list > a[selected] {\n    color: var(--app-drawer-selected-color);\n  }\n\n  app-toolbar nav.toolbar-list {\n    display: none;\n  }\n\n  app-drawer {\n    z-index: 1;\n  }\n\n  @media (min-width: 460px) {\n    [main-title] {\n      padding-right: 0px;\n      max-width: var(--app-max-width);\n    }\n\n    h2 {\n      text-align: left;\n    }\n\n    nav.toolbar-list {\n      display: flex;\n    }\n\n    .menu-btn {\n      display: none;\n    }\n  }\n"]);_templateObject11_27d9fd20813811e99f94edb206e3123b=function _templateObject11_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject10_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["<svg height=\"24\" viewBox=\"0 0 24 24\" width=\"24\"><path d=\"M0 0h24v24H0z\" fill=\"none\"/><path d=\"M13 7h-2v4H7v2h4v4h2v-4h4v-2h-4V7zm-1-5C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z\"/></svg>"]);_templateObject10_27d9fd20813811e99f94edb206e3123b=function _templateObject10_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject9_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["<svg height=\"24\" viewBox=\"0 0 24 24\" width=\"24\"><path d=\"M0 0h24v24H0z\" fill=\"none\"/><path d=\"M7 11v2h10v-2H7zm5-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z\"/></svg>"]);_templateObject9_27d9fd20813811e99f94edb206e3123b=function _templateObject9_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject8_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["<svg height=\"24\" viewBox=\"0 0 24 24\" width=\"24\"><path d=\"M22.73 22.73L2.77 2.77 2 2l-.73-.73L0 2.54l4.39 4.39 2.21 4.66-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h7.46l1.38 1.38c-.5.36-.83.95-.83 1.62 0 1.1.89 2 1.99 2 .67 0 1.26-.33 1.62-.84L21.46 24l1.27-1.27zM7.42 15c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h2.36l2 2H7.42zm8.13-2c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.12-.31.12-.48 0-.55-.45-1-1-1H6.54l9.01 9zM7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2z\"/><path d=\"M0 0h24v24H0z\" fill=\"none\"/></svg>"]);_templateObject8_27d9fd20813811e99f94edb206e3123b=function _templateObject8_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject7_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["<svg height=\"24\" viewBox=\"0 0 24 24\" width=\"24\"><path d=\"M0 0h24v24H0zm18.31 6l-2.76 5z\" fill=\"none\"/><path id=\"cart-path\" d=\"M11 9h2V6h3V4h-3V1h-2v3H8v2h3v3zm-4 9c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zm10 0c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2zm-9.83-3.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.86-7.01L19.42 4h-.01l-1.1 2-2.76 5H8.53l-.13-.27L6.16 6l-.95-2-.94-2H1v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.13 0-.25-.11-.25-.25z\"/></svg>"]);_templateObject7_27d9fd20813811e99f94edb206e3123b=function _templateObject7_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject6_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["<svg height=\"24\" viewBox=\"0 0 24 24\" width=\"24\"><path d=\"M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z\"></path></svg>"]);_templateObject6_27d9fd20813811e99f94edb206e3123b=function _templateObject6_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject5_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n  :host {\n    display: block;\n    box-sizing: border-box;\n  }\n\n  section {\n    padding: 24px;\n    background: var(--app-section-odd-color);\n  }\n\n  section > * {\n    max-width: var(--app-max-width);\n    margin-right: auto;\n    margin-left: auto;\n  }\n\n  section:nth-of-type(even) {\n    background: var(--app-section-even-color);\n  }\n\n  h1,\n  h2,\n  h3,\n  h4,\n  h5,\n  h6 {\n    font-family: var(--app-heading-font);\n    text-align: left;\n    margin: 0;\n    padding: 8px;\n  }\n\n  h2 {\n    font-size: 32pt;\n    margin-bottom: 0.1em;\n  }\n\n  h3 {\n    font-size: 26pt;\n    margin-top: 1em;\n  }\n\n  @media (min-width: 460px) {\n    h2 {\n      font-size: 36px;\n    }\n  }\n\n  .circle {\n    display: block;\n    width: 64px;\n    height: 64px;\n    margin: 0 auto;\n    text-align: center;\n    border-radius: 50%;\n    background: var(--app-primary-color);\n    color: var(--app-light-text-color);\n    font-size: 30px;\n    line-height: 64px;\n  }\n"]);_templateObject5_27d9fd20813811e99f94edb206e3123b=function _templateObject5_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject4_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n\n      :host {\n        @apply --layout-horizontal;\n        @apply --layout-center;\n        position: relative;\n        height: 64px;\n        padding: 0 16px;\n        pointer-events: none;\n        font-size: var(--app-toolbar-font-size, 20px);\n      }\n\n      :host ::slotted(*) {\n        pointer-events: auto;\n      }\n\n      :host ::slotted(paper-icon-button) {\n        /* paper-icon-button/issues/33 */\n        font-size: 0;\n      }\n\n      :host ::slotted([main-title]),\n      :host ::slotted([condensed-title]) {\n        pointer-events: none;\n        @apply --layout-flex;\n      }\n\n      :host ::slotted([bottom-item]) {\n        position: absolute;\n        right: 0;\n        bottom: 0;\n        left: 0;\n      }\n\n      :host ::slotted([top-item]) {\n        position: absolute;\n        top: 0;\n        right: 0;\n        left: 0;\n      }\n\n      :host ::slotted([spacer]) {\n        margin-left: 64px;\n      }\n    </style>\n\n    <slot></slot>\n"]);_templateObject4_27d9fd20813811e99f94edb206e3123b=function _templateObject4_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject3_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        position: relative;\n        display: block;\n        transition-timing-function: linear;\n        transition-property: -webkit-transform;\n        transition-property: transform;\n      }\n\n      :host::before {\n        position: absolute;\n        right: 0px;\n        bottom: -5px;\n        left: 0px;\n        width: 100%;\n        height: 5px;\n        content: \"\";\n        transition: opacity 0.4s;\n        pointer-events: none;\n        opacity: 0;\n        box-shadow: inset 0px 5px 6px -3px rgba(0, 0, 0, 0.4);\n        will-change: opacity;\n        @apply --app-header-shadow;\n      }\n\n      :host([shadow])::before {\n        opacity: 1;\n      }\n\n      #background {\n        @apply --layout-fit;\n        overflow: hidden;\n      }\n\n      #backgroundFrontLayer,\n      #backgroundRearLayer {\n        @apply --layout-fit;\n        height: 100%;\n        pointer-events: none;\n        background-size: cover;\n      }\n\n      #backgroundFrontLayer {\n        @apply --app-header-background-front-layer;\n      }\n\n      #backgroundRearLayer {\n        opacity: 0;\n        @apply --app-header-background-rear-layer;\n      }\n\n      #contentContainer {\n        position: relative;\n        width: 100%;\n        height: 100%;\n      }\n\n      :host([disabled]),\n      :host([disabled])::after,\n      :host([disabled]) #backgroundFrontLayer,\n      :host([disabled]) #backgroundRearLayer,\n      /* Silent scrolling should not run CSS transitions */\n      :host([silent-scroll]),\n      :host([silent-scroll])::after,\n      :host([silent-scroll]) #backgroundFrontLayer,\n      :host([silent-scroll]) #backgroundRearLayer {\n        transition: none !important;\n      }\n\n      :host([disabled]) ::slotted(app-toolbar:first-of-type),\n      :host([disabled]) ::slotted([sticky]),\n      /* Silent scrolling should not run CSS transitions */\n      :host([silent-scroll]) ::slotted(app-toolbar:first-of-type),\n      :host([silent-scroll]) ::slotted([sticky]) {\n        transition: none !important;\n      }\n\n    </style>\n    <div id=\"contentContainer\">\n      <slot id=\"slot\"></slot>\n    </div>\n"]);_templateObject3_27d9fd20813811e99f94edb206e3123b=function _templateObject3_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject2_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        position: fixed;\n        top: -120px;\n        right: 0;\n        bottom: -120px;\n        left: 0;\n\n        visibility: hidden;\n\n        transition-property: visibility;\n      }\n\n      :host([opened]) {\n        visibility: visible;\n      }\n\n      :host([persistent]) {\n        width: var(--app-drawer-width, 256px);\n      }\n\n      :host([persistent][position=left]) {\n        right: auto;\n      }\n\n      :host([persistent][position=right]) {\n        left: auto;\n      }\n\n      #contentContainer {\n        position: absolute;\n        top: 0;\n        bottom: 0;\n        left: 0;\n\n        width: var(--app-drawer-width, 256px);\n        padding: 120px 0;\n\n        transition-property: -webkit-transform;\n        transition-property: transform;\n        -webkit-transform: translate3d(-100%, 0, 0);\n        transform: translate3d(-100%, 0, 0);\n\n        background-color: #FFF;\n\n        @apply --app-drawer-content-container;\n      }\n\n      #contentContainer[persistent] {\n        width: 100%;\n      }\n\n      #contentContainer[position=right] {\n        right: 0;\n        left: auto;\n\n        -webkit-transform: translate3d(100%, 0, 0);\n        transform: translate3d(100%, 0, 0);\n      }\n\n      #contentContainer[swipe-open]::after {\n        position: fixed;\n        top: 0;\n        bottom: 0;\n        left: 100%;\n\n        visibility: visible;\n\n        width: 20px;\n\n        content: '';\n      }\n\n      #contentContainer[swipe-open][position=right]::after {\n        right: 100%;\n        left: auto;\n      }\n\n      #contentContainer[opened] {\n        -webkit-transform: translate3d(0, 0, 0);\n        transform: translate3d(0, 0, 0);\n      }\n\n      #scrim {\n        position: absolute;\n        top: 0;\n        right: 0;\n        bottom: 0;\n        left: 0;\n\n        transition-property: opacity;\n        -webkit-transform: translateZ(0);\n        transform:  translateZ(0);\n\n        opacity: 0;\n        background: var(--app-drawer-scrim-background, rgba(0, 0, 0, 0.5));\n      }\n\n      #scrim.visible {\n        opacity: 1;\n      }\n\n      :host([no-transition]) #contentContainer {\n        transition-property: none;\n      }\n    </style>\n\n    <div id=\"scrim\" on-click=\"close\"></div>\n\n    <!-- HACK(keanulee): Bind attributes here (in addition to :host) for styling to workaround Safari\n    bug. https://bugs.webkit.org/show_bug.cgi?id=170762 -->\n    <div id=\"contentContainer\" opened$=\"[[opened]]\" persistent$=\"[[persistent]]\" position$=\"[[position]]\" swipe-open$=\"[[swipeOpen]]\">\n      <slot></slot>\n    </div>\n"],["\n    <style>\n      :host {\n        position: fixed;\n        top: -120px;\n        right: 0;\n        bottom: -120px;\n        left: 0;\n\n        visibility: hidden;\n\n        transition-property: visibility;\n      }\n\n      :host([opened]) {\n        visibility: visible;\n      }\n\n      :host([persistent]) {\n        width: var(--app-drawer-width, 256px);\n      }\n\n      :host([persistent][position=left]) {\n        right: auto;\n      }\n\n      :host([persistent][position=right]) {\n        left: auto;\n      }\n\n      #contentContainer {\n        position: absolute;\n        top: 0;\n        bottom: 0;\n        left: 0;\n\n        width: var(--app-drawer-width, 256px);\n        padding: 120px 0;\n\n        transition-property: -webkit-transform;\n        transition-property: transform;\n        -webkit-transform: translate3d(-100%, 0, 0);\n        transform: translate3d(-100%, 0, 0);\n\n        background-color: #FFF;\n\n        @apply --app-drawer-content-container;\n      }\n\n      #contentContainer[persistent] {\n        width: 100%;\n      }\n\n      #contentContainer[position=right] {\n        right: 0;\n        left: auto;\n\n        -webkit-transform: translate3d(100%, 0, 0);\n        transform: translate3d(100%, 0, 0);\n      }\n\n      #contentContainer[swipe-open]::after {\n        position: fixed;\n        top: 0;\n        bottom: 0;\n        left: 100%;\n\n        visibility: visible;\n\n        width: 20px;\n\n        content: '';\n      }\n\n      #contentContainer[swipe-open][position=right]::after {\n        right: 100%;\n        left: auto;\n      }\n\n      #contentContainer[opened] {\n        -webkit-transform: translate3d(0, 0, 0);\n        transform: translate3d(0, 0, 0);\n      }\n\n      #scrim {\n        position: absolute;\n        top: 0;\n        right: 0;\n        bottom: 0;\n        left: 0;\n\n        transition-property: opacity;\n        -webkit-transform: translateZ(0);\n        transform:  translateZ(0);\n\n        opacity: 0;\n        background: var(--app-drawer-scrim-background, rgba(0, 0, 0, 0.5));\n      }\n\n      #scrim.visible {\n        opacity: 1;\n      }\n\n      :host([no-transition]) #contentContainer {\n        transition-property: none;\n      }\n    </style>\n\n    <div id=\"scrim\" on-click=\"close\"></div>\n\n    <!-- HACK(keanulee): Bind attributes here (in addition to :host) for styling to workaround Safari\n    bug. https://bugs.webkit.org/show_bug.cgi?id=170762 -->\n    <div id=\"contentContainer\" opened\\$=\"[[opened]]\" persistent\\$=\"[[persistent]]\" position\\$=\"[[position]]\" swipe-open\\$=\"[[swipeOpen]]\">\n      <slot></slot>\n    </div>\n"]);_templateObject2_27d9fd20813811e99f94edb206e3123b=function _templateObject2_27d9fd20813811e99f94edb206e3123b(){return data};return data}function _templateObject_27d9fd20813811e99f94edb206e3123b(){var data=babelHelpers.taggedTemplateLiteral(["\n<custom-style>\n  <style is=\"custom-style\">\n    [hidden] {\n      display: none !important;\n    }\n  </style>\n</custom-style>\n<custom-style>\n  <style is=\"custom-style\">\n    html {\n\n      --layout: {\n        display: -ms-flexbox;\n        display: -webkit-flex;\n        display: flex;\n      };\n\n      --layout-inline: {\n        display: -ms-inline-flexbox;\n        display: -webkit-inline-flex;\n        display: inline-flex;\n      };\n\n      --layout-horizontal: {\n        @apply --layout;\n\n        -ms-flex-direction: row;\n        -webkit-flex-direction: row;\n        flex-direction: row;\n      };\n\n      --layout-horizontal-reverse: {\n        @apply --layout;\n\n        -ms-flex-direction: row-reverse;\n        -webkit-flex-direction: row-reverse;\n        flex-direction: row-reverse;\n      };\n\n      --layout-vertical: {\n        @apply --layout;\n\n        -ms-flex-direction: column;\n        -webkit-flex-direction: column;\n        flex-direction: column;\n      };\n\n      --layout-vertical-reverse: {\n        @apply --layout;\n\n        -ms-flex-direction: column-reverse;\n        -webkit-flex-direction: column-reverse;\n        flex-direction: column-reverse;\n      };\n\n      --layout-wrap: {\n        -ms-flex-wrap: wrap;\n        -webkit-flex-wrap: wrap;\n        flex-wrap: wrap;\n      };\n\n      --layout-wrap-reverse: {\n        -ms-flex-wrap: wrap-reverse;\n        -webkit-flex-wrap: wrap-reverse;\n        flex-wrap: wrap-reverse;\n      };\n\n      --layout-flex-auto: {\n        -ms-flex: 1 1 auto;\n        -webkit-flex: 1 1 auto;\n        flex: 1 1 auto;\n      };\n\n      --layout-flex-none: {\n        -ms-flex: none;\n        -webkit-flex: none;\n        flex: none;\n      };\n\n      --layout-flex: {\n        -ms-flex: 1 1 0.000000001px;\n        -webkit-flex: 1;\n        flex: 1;\n        -webkit-flex-basis: 0.000000001px;\n        flex-basis: 0.000000001px;\n      };\n\n      --layout-flex-2: {\n        -ms-flex: 2;\n        -webkit-flex: 2;\n        flex: 2;\n      };\n\n      --layout-flex-3: {\n        -ms-flex: 3;\n        -webkit-flex: 3;\n        flex: 3;\n      };\n\n      --layout-flex-4: {\n        -ms-flex: 4;\n        -webkit-flex: 4;\n        flex: 4;\n      };\n\n      --layout-flex-5: {\n        -ms-flex: 5;\n        -webkit-flex: 5;\n        flex: 5;\n      };\n\n      --layout-flex-6: {\n        -ms-flex: 6;\n        -webkit-flex: 6;\n        flex: 6;\n      };\n\n      --layout-flex-7: {\n        -ms-flex: 7;\n        -webkit-flex: 7;\n        flex: 7;\n      };\n\n      --layout-flex-8: {\n        -ms-flex: 8;\n        -webkit-flex: 8;\n        flex: 8;\n      };\n\n      --layout-flex-9: {\n        -ms-flex: 9;\n        -webkit-flex: 9;\n        flex: 9;\n      };\n\n      --layout-flex-10: {\n        -ms-flex: 10;\n        -webkit-flex: 10;\n        flex: 10;\n      };\n\n      --layout-flex-11: {\n        -ms-flex: 11;\n        -webkit-flex: 11;\n        flex: 11;\n      };\n\n      --layout-flex-12: {\n        -ms-flex: 12;\n        -webkit-flex: 12;\n        flex: 12;\n      };\n\n      /* alignment in cross axis */\n\n      --layout-start: {\n        -ms-flex-align: start;\n        -webkit-align-items: flex-start;\n        align-items: flex-start;\n      };\n\n      --layout-center: {\n        -ms-flex-align: center;\n        -webkit-align-items: center;\n        align-items: center;\n      };\n\n      --layout-end: {\n        -ms-flex-align: end;\n        -webkit-align-items: flex-end;\n        align-items: flex-end;\n      };\n\n      --layout-baseline: {\n        -ms-flex-align: baseline;\n        -webkit-align-items: baseline;\n        align-items: baseline;\n      };\n\n      /* alignment in main axis */\n\n      --layout-start-justified: {\n        -ms-flex-pack: start;\n        -webkit-justify-content: flex-start;\n        justify-content: flex-start;\n      };\n\n      --layout-center-justified: {\n        -ms-flex-pack: center;\n        -webkit-justify-content: center;\n        justify-content: center;\n      };\n\n      --layout-end-justified: {\n        -ms-flex-pack: end;\n        -webkit-justify-content: flex-end;\n        justify-content: flex-end;\n      };\n\n      --layout-around-justified: {\n        -ms-flex-pack: distribute;\n        -webkit-justify-content: space-around;\n        justify-content: space-around;\n      };\n\n      --layout-justified: {\n        -ms-flex-pack: justify;\n        -webkit-justify-content: space-between;\n        justify-content: space-between;\n      };\n\n      --layout-center-center: {\n        @apply --layout-center;\n        @apply --layout-center-justified;\n      };\n\n      /* self alignment */\n\n      --layout-self-start: {\n        -ms-align-self: flex-start;\n        -webkit-align-self: flex-start;\n        align-self: flex-start;\n      };\n\n      --layout-self-center: {\n        -ms-align-self: center;\n        -webkit-align-self: center;\n        align-self: center;\n      };\n\n      --layout-self-end: {\n        -ms-align-self: flex-end;\n        -webkit-align-self: flex-end;\n        align-self: flex-end;\n      };\n\n      --layout-self-stretch: {\n        -ms-align-self: stretch;\n        -webkit-align-self: stretch;\n        align-self: stretch;\n      };\n\n      --layout-self-baseline: {\n        -ms-align-self: baseline;\n        -webkit-align-self: baseline;\n        align-self: baseline;\n      };\n\n      /* multi-line alignment in main axis */\n\n      --layout-start-aligned: {\n        -ms-flex-line-pack: start;  /* IE10 */\n        -ms-align-content: flex-start;\n        -webkit-align-content: flex-start;\n        align-content: flex-start;\n      };\n\n      --layout-end-aligned: {\n        -ms-flex-line-pack: end;  /* IE10 */\n        -ms-align-content: flex-end;\n        -webkit-align-content: flex-end;\n        align-content: flex-end;\n      };\n\n      --layout-center-aligned: {\n        -ms-flex-line-pack: center;  /* IE10 */\n        -ms-align-content: center;\n        -webkit-align-content: center;\n        align-content: center;\n      };\n\n      --layout-between-aligned: {\n        -ms-flex-line-pack: justify;  /* IE10 */\n        -ms-align-content: space-between;\n        -webkit-align-content: space-between;\n        align-content: space-between;\n      };\n\n      --layout-around-aligned: {\n        -ms-flex-line-pack: distribute;  /* IE10 */\n        -ms-align-content: space-around;\n        -webkit-align-content: space-around;\n        align-content: space-around;\n      };\n\n      /*******************************\n                Other Layout\n      *******************************/\n\n      --layout-block: {\n        display: block;\n      };\n\n      --layout-invisible: {\n        visibility: hidden !important;\n      };\n\n      --layout-relative: {\n        position: relative;\n      };\n\n      --layout-fit: {\n        position: absolute;\n        top: 0;\n        right: 0;\n        bottom: 0;\n        left: 0;\n      };\n\n      --layout-scroll: {\n        -webkit-overflow-scrolling: touch;\n        overflow: auto;\n      };\n\n      --layout-fullbleed: {\n        margin: 0;\n        height: 100vh;\n      };\n\n      /* fixed position */\n\n      --layout-fixed-top: {\n        position: fixed;\n        top: 0;\n        left: 0;\n        right: 0;\n      };\n\n      --layout-fixed-right: {\n        position: fixed;\n        top: 0;\n        right: 0;\n        bottom: 0;\n      };\n\n      --layout-fixed-bottom: {\n        position: fixed;\n        right: 0;\n        bottom: 0;\n        left: 0;\n      };\n\n      --layout-fixed-left: {\n        position: fixed;\n        top: 0;\n        bottom: 0;\n        left: 0;\n      };\n\n    }\n  </style>\n</custom-style>"]);_templateObject_27d9fd20813811e99f94edb206e3123b=function _templateObject_27d9fd20813811e99f94edb206e3123b(){return data};return data}var nativeShadow=!(window.ShadyDOM&&window.ShadyDOM.inUse);_exports.nativeShadow=nativeShadow;var nativeCssVariables_;/**
 ...
 */function stylesFromModules(moduleIds){for(var modules=moduleIds.trim().split(/\s+/),styles=[],i=0;i<modules.length;i++){styles.push.apply(styles,babelHelpers.toConsumableArray(stylesFromModule(modules[i])))}return styles}/**
   ...
   */function stylesFromModule(moduleId){var m=importModule(moduleId);if(!m){console.warn("Could not find style data in module named",moduleId);return[]}if(m._styles===void 0){var _styles=[];// module imports: <link rel="import" type="css">
_styles.push.apply(_styles,babelHelpers.toConsumableArray(_stylesFromModuleImports(m)));// include css from the first template in the module
var _template2=/** @type {?HTMLTemplateElement} */m.querySelector("template");if(_template2){_styles.push.apply(_styles,babelHelpers.toConsumableArray(stylesFromTemplate(_template2,/** @type {templateWithAssetPath} */m.assetpath)))}m._styles=_styles}return m._styles}/**
   * Returns the `<style>` elements within a given template.
   *
   * @param {!HTMLTemplateElement} template Template to gather styles from
   * @param {string} baseURI baseURI for style content
   * @return {!Array<!HTMLStyleElement>} Array of styles
   */function stylesFromTemplate(template,baseURI){if(!template._styles){for(var _styles2=[],e$=template.content.querySelectorAll("style"),i=0;i<e$.length;i++){var e=e$[i],include=e.getAttribute(INCLUDE_ATTR);// support style sharing by allowing styles to "include"
// other dom-modules that contain styling
if(include){_styles2.push.apply(_styles2,babelHelpers.toConsumableArray(stylesFromModules(include).filter(function(item,index,self){return self.indexOf(item)===index})))}if(baseURI){e.textContent=resolveCss(e.textContent,baseURI)}_styles2.push(e)}template._styles=_styles2}return template._styles}/**
...
outValue=value}break;case Array:try{outValue=JSON.parse(/** @type {string} */value)}catch(x){outValue=null;console.warn("Polymer::Attributes: couldn't decode Array as JSON: ".concat(value))}break;case Date:outValue=isNaN(value)?value+"":+value;outValue=new Date(outValue);break;default:outValue=babelHelpers.get(babelHelpers.getPrototypeOf(PropertyAccessors.prototype),"_deserializeValue",this).call(this,value,type);break;}return outValue}/* eslint-enable no-fallthrough */ /**
     ...
     *
     * @return {void}
     */value:function createPropertiesForAttributes(){for(var a$=this.observedAttributes,_i3=0;_i3<a$.length;_i3++){this.prototype._createPropertyAccessor(dashToCamelCase(a$[_i3]))}}/**
       * Returns an attribute name that corresponds to the given property.
...
propPath=normalize(path)}else{propPath=/** @type{string} */path}if(this._setPendingPropertyOrPath(propPath,value,!0,!0)){this._invalidateProperties()}}/**
       ...
       * @private
       */},{key:"_marshalArgs",value:function _marshalArgs(args,path,props){for(var data=this.__data,values=[],_i15=0,l=args.length;_i15<l;_i15++){var arg=args[_i15],name=arg.name,v=void 0;if(arg.literal){v=arg.value}else{if(arg.structured){v=_get(data,name);// when data is not stored e.g. `splices`
...
var baseChanged=0===name.indexOf(path+"."),_matches=0===path.indexOf(name)&&!baseChanged;values[_i15]={path:_matches?path:name,value:_matches?props[path]:v,base:v}}else{values[_i15]=v}}return values}// -- static class methods ------------
/**
...
if("click"===mouseEvent.type){var clickFromLabel=!1,_path2=mouseEvent.composedPath&&mouseEvent.composedPath();if(_path2){for(var _i21=0;_i21<_path2.length;_i21++){if(_path2[_i21].nodeType===Node.ELEMENT_NODE){if("label"===_path2[_i21].localName){clickedLabels.push(_path2[_i21])}else if(canBeLabelled(_path2[_i21])){// check if one of the clicked labels is labelling this element
for(var ownerLabels=matchingLabels(_path2[_i21]),j=0;j<ownerLabels.length;j++){clickFromLabel=clickFromLabel||-1<clickedLabels.indexOf(ownerLabels[j])}}}if(_path2[_i21]===POINTERSTATE.mouse.target){return}}}// if one of the clicked labels was labelling the target element,
...
n=n.parentNode||n.host}return n===this.node}/**
     ...
     */},{key:"activeElement",get:function get(){var node=this.node;return node._activeElement!==void 0?node._activeElement:node.activeElement}}]);return DomApi}();_exports.DomApi=DomApi;function forwardMethods(proto,methods){for(var _loop=function _loop(_i42){var method=methods[_i42];/* eslint-disable valid-jsdoc */proto[method]=/** @this {DomApi} */function(){return this.node[method].apply(this.node,arguments)};/* eslint-enable */},_i42=0;_i42<methods.length;_i42++){_loop(_i42)}}function forwardReadOnlyProperties(proto,properties){for(var _loop2=function _loop2(_i43){var name=properties[_i43];Object.defineProperty(proto,name,{get:function get(){var domApi=/** @type {DomApi} */this;return domApi.node[name]},configurable:!0})},_i43=0;_i43<properties.length;_i43++){_loop2(_i43)}}function forwardProperties(proto,properties){for(var _loop3=function _loop3(_i44){var name=properties[_i44];Object.defineProperty(proto,name,{/**
       * @this {DomApi}
       * @return {*} .
                               ...
                               */DomApi.prototype.replaceChild;/**
                                ...
                                */DomApi.prototype.removeAttribute;/**
                                 ...
                                 */DomApi.prototype.querySelectorAll;/** @type {?Node} */DomApi.prototype.parentNode;/** @type {?Node} */DomApi.prototype.firstChild;/** @type {?Node} */DomApi.prototype.lastChild;/** @type {?Node} */DomApi.prototype.nextSibling;/** @type {?Node} */DomApi.prototype.previousSibling;/** @type {?HTMLElement} */DomApi.prototype.firstElementChild;/** @type {?HTMLElement} */DomApi.prototype.lastElementChild;/** @type {?HTMLElement} */DomApi.prototype.nextElementSibling;/** @type {?HTMLElement} */DomApi.prototype.previousElementSibling;/** @type {!Array<!Node>} */DomApi.prototype.childNodes;/** @type {!Array<!HTMLElement>} */DomApi.prototype.children;/** @type {?DOMTokenList} */DomApi.prototype.classList;/** @type {string} */DomApi.prototype.textContent;/** @type {string} */DomApi.prototype.innerHTML;forwardMethods(DomApi.prototype,["cloneNode","appendChild","insertBefore","removeChild","replaceChild","setAttribute","removeAttribute","querySelector","querySelectorAll"]);forwardReadOnlyProperties(DomApi.prototype,["parentNode","firstChild","lastChild","nextSibling","previousSibling","firstElementChild","lastElementChild","nextElementSibling","previousElementSibling","childNodes","children","classList"]);forwardProperties(DomApi.prototype,["textContent","innerHTML"]);/**
                                                                    ...
                                                                    */var dom=function dom(obj){obj=obj||document;if(!obj.__domApi){var helper;if(babelHelpers.instanceof(obj,Event)){helper=new EventApi(obj)}else{helper=new DomApi(obj)}obj.__domApi=helper}return obj.__domApi};_exports.dom=dom;var polymer_dom={matchesSelector:matchesSelector,DomApi:DomApi,EventApi:EventApi,dom:dom,flush:flush$1,addDebouncer:enqueueDebouncer};_exports.$polymerDom=polymer_dom;var bundledImportMeta$1=babelHelpers.objectSpread({},meta,{url:new URL("../../node_modules/%40polymer/polymer/lib/legacy/legacy-element-mixin.js",meta.url).href}),styleInterface=window.ShadyCSS,LegacyElementMixin=dedupingMixin(function(base){/**
   * @constructor
   * @extends {base}
   * @implements {Polymer_ElementMixin}
   * @implements {Polymer_GestureEventListeners}
...
/**
     ...
     */},{key:"_initializeProperties",value:function _initializeProperties(){var proto=Object.getPrototypeOf(this);if(!proto.hasOwnProperty("__hasRegisterFinished")){proto.__hasRegisterFinished=!0;this._registered()}babelHelpers.get(babelHelpers.getPrototypeOf(LegacyElement.prototype),"_initializeProperties",this).call(this);this.root=/** @type {HTMLElement} */this;this.created()}/**
       ...
       */},{key:"extend",value:function extend(prototype,api){if(!(prototype&&api)){return prototype||api}for(var n$=Object.getOwnPropertyNames(api),_i45=0,n,pd;_i45<n$.length&&(n=n$[_i45]);_i45++){pd=Object.getOwnPropertyDescriptor(api,n);if(pd){Object.defineProperty(prototype,n,pd)}}return prototype}/**
       ...
       */},{key:"getEffectiveTextContent",value:function getEffectiveTextContent(){for(var cn=this.getEffectiveChildNodes(),tc=[],_i47=0,c;c=cn[_i47];_i47++){if(c.nodeType!==Node.COMMENT_NODE){tc.push(c.textContent)}}return tc.join("")}/**
...
// (again same as 1.x)
function _mixinBehaviors(behaviors,klass){for(var _i48=0,b;_i48<behaviors.length;_i48++){b=behaviors[_i48];if(b){klass=Array.isArray(b)?_mixinBehaviors(b,klass):GenerateClassFromInfo(b,klass)}}return klass}/**
   * @param {Array} behaviors List of behaviors to flatten.
   * @param {Array=} list Target list to flatten behaviors into.
   * @param {Array=} exclude List of behaviors to exclude from the list.
   * @return {!Array} Returns the list of flattened behaviors.
   */function flattenBehaviors(behaviors,list,exclude){list=list||[];for(var _i49=behaviors.length-1,b;0<=_i49;_i49--){b=behaviors[_i49];if(b){if(Array.isArray(b)){flattenBehaviors(b,list)}else{// dedup
...
for(var children=_this18.children=[],n=_this18.root.firstChild;n;n=n.nextSibling){children.push(n);n.__templatizeInstance=babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this18))}if(_this18.__templatizeOwner&&_this18.__templatizeOwner.__hideTemplateChildren__){_this18._showHideChildren(!0)}// Flush props only when props are passed if instance props exist
...
var templateHost=this.__dataHost.__dataHost;if(templateHost){templateHost._addEventListenerToNode(node,eventName,handler)}}}/**
     ...
     * @return {void}
     * @protected
     */},{key:"_showHideChildren",value:function _showHideChildren(hide){for(var c=this.children,_i50=0,n;_i50<c.length;_i50++){n=c[_i50];// Ignore non-changes
...
get:function get(){return"dom-repeat"}},{key:"template",get:function get(){return null}},{key:"properties",get:function get(){/**
     ...
     * @override
     * @return {void}
     */babelHelpers.createClass(DomRepeat,[{key:"disconnectedCallback",value:function disconnectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(DomRepeat.prototype),"disconnectedCallback",this).call(this);this.__isDetached=!0;for(var _i52=0;_i52<this.__instances.length;_i52++){this.__detachInstance(_i52)}}/**
     * @override
     * @return {void}
...
if(this.__isDetached){this.__isDetached=!1;for(var parent=this.parentNode,_i53=0;_i53<this.__instances.length;_i53++){this.__attachInstance(_i53,parent)}}}},{key:"__ensureTemplatized",value:function __ensureTemplatized(){var _this23=this;// Templatizing (generating the instance constructor) needs to wait
...
var instanceProps={};instanceProps[this.as]=!0;instanceProps[this.indexAs]=!0;instanceProps[this.itemsIndexAs]=!0;this.__ctor=_templatize(_template3,this,{mutableData:this.mutableData,parentModel:!0,instanceProps:instanceProps,/**
         ...
         */forwardHostProp:function forwardHostProp(prop,value){for(var i$=this.__instances,_i54=0,inst;_i54<i$.length&&(inst=i$[_i54]);_i54++){inst.forwardHostProp(prop,value)}},/**
         * @this {DomRepeat}
...
for(var paths=this.__observePaths,_i55=0;_i55<paths.length;_i55++){if(0===path.indexOf(paths[_i55])){this.__debounceRender(this.__render,this.delay)}}}}}/**
...
this.__tryRenderChunk()}},{key:"__applyFullRefresh",value:function __applyFullRefresh(){for(var _this25=this,items=this.items||[],isntIdxToItemsIdx=Array(items.length),_i56=0;_i56<items.length;_i56++){isntIdxToItemsIdx[_i56]=_i56}// Apply user filter
...
var _part5=path.slice("items.".length),idx=parseInt(_part5,10);if(0>_part5.indexOf(".")&&_part5==idx){this.__deselectChangedIdx(idx)}}}},{key:"__applySplices",value:function __applySplices(splices){// Adjust selected indices and mark removals
for(var _this30=this,selected=this.__selectedMap,_loop4=function _loop4(_i62){var s=splices[_i62];selected.forEach(function(idx,item){if(idx<s.index){// no change
}else if(idx>=s.index+s.removed.length){// adjust index
selected.set(item,idx+s.addedCount-s.removed.length)}else{// remove index
selected.set(item,-1)}});for(var j=0,idx;j<s.addedCount;j++){idx=s.index+j;if(selected.has(_this30.items[idx])){selected.set(_this30.items[idx],idx)}}},_i62=0;_i62<splices.length;_i62++){_loop4(_i62)}// Update linked paths
...
if(30<Math.abs(this._initScrollTop-scrollTop)||10<absDScrollTop){if(isScrollingDown&&scrollTop>=maxHeaderTop){top=maxHeaderTop}else if(!isScrollingDown&&scrollTop>=this._dHeight){top=this.condenses&&!this.fixed?this._dHeight:0}var scrollVelocity=dScrollTop/(now-this._lastTimestamp);this.style.transitionDuration=this._clamp((top-lastTop)/scrollVelocity,0,300)+"ms"}else{top=this._top}}}if(0===this._dHeight){progress=0<scrollTop?1:0}else{progress=top/this._dHeight}if(!forceUpdate){this._lastScrollTop=scrollTop;this._top=top;this._wasScrollingDown=isScrollingDown;this._lastTimestamp=now}if(forceUpdate||progress!==this._progress||lastTop!==top||0===scrollTop){this._progress=progress;this._runEffects(progress,top);this._transformHeader(top)}},/**
   ...
   */run:function run(){this.shadow=this.isOnScreen()&&this.isContentBelow()}});Polymer({_template:html(_templateObject4_27d9fd20813811e99f94edb206e3123b()),is:"app-toolbar"});/**
    @license
...
return old!==value&&(old===old||value===value)};_exports.notEqual$1=_exports.notEqual=notEqual;var defaultPropertyDeclaration={attribute:!0,type:String,converter:defaultConverter,reflect:!1,hasChanged:notEqual},microtaskPromise=Promise.resolve(!0),STATE_HAS_UPDATED=1,STATE_UPDATE_REQUESTED=1<<2,STATE_IS_REFLECTING_TO_ATTRIBUTE=1<<3,STATE_IS_REFLECTING_TO_PROPERTY=1<<4,STATE_HAS_CONNECTED=1<<5,UpdatingElement=/*#__PURE__*/function(_HTMLElement3){babelHelpers.inherits(UpdatingElement,_HTMLElement3);function UpdatingElement(){var _this34;babelHelpers.classCallCheck(this,UpdatingElement);_this34=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(UpdatingElement).call(this));_this34._updateState=0;_this34._instanceProperties=void 0;_this34._updatePromise=microtaskPromise;_this34._hasConnectedResolver=void 0;/**
     ...
     */value:function initialize(){this._saveInstanceProperties();// ensures first update will be caught by an early access of `updateComplete`
this._requestUpdate()}/**
...
// expecting arrays
// tslint:disable-next-line:no-any
this._instanceProperties.forEach(function(v,p){return _this36[p]=v});this._instanceProperties=void 0}},{key:"connectedCallback",value:function connectedCallback(){this._updateState=this._updateState|STATE_HAS_CONNECTED;// Ensure first connection completes an update. Updates cannot complete before
...
get:function get(){return this[key]},set:function set(value){// tslint:disable-next-line:no-any no symbol in index
...
if(this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){var _props3=this.properties,propKeys=babelHelpers.toConsumableArray(Object.getOwnPropertyNames(_props3)).concat(babelHelpers.toConsumableArray("function"===typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(_props3):[])),_iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;// support symbols in properties (IE11 does not support this)
try{// This for/of is ok because propKeys is an array
for(var _iterator=propKeys[Symbol.iterator](),_step,_p14;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=!0){_p14=_step.value;// note, use of `any` is due to TypeSript lack of support for symbol in
// index types
// tslint:disable-next-line:no-any no symbol in index
this.createProperty(_p14,_props3[_p14])}}catch(err){_didIteratorError=!0;_iteratorError=err}finally{try{if(!_iteratorNormalCompletion&&null!=_iterator.return){_iterator.return()}}finally{if(_didIteratorError){throw _iteratorError}}}}}/**
...
for(var parent=node.parentNode,_strings=data.split(markerRegex),lastIndex=_strings.length-1,_i65=0;_i65<lastIndex;_i65++){var insert=void 0,s=_strings[_i65];if(""===s){insert=createMarker()}else{var match=lastAttributeNameRegex.exec(s);if(null!==match&&endsWith(match[2],boundAttributeSuffix)){s=s.slice(0,match.index)+match[1]+match[2].slice(0,-boundAttributeSuffix.length)+match[3]}insert=document.createTextNode(s)}parent.insertBefore(insert,node);this.parts.push({type:"node",index:++index})}// If there's no text, we must insert a comment to mark our place.
...
if(null===node.nextSibling){node.data=""}else{nodesToRemove.push(node);index--}partIndex++}else{var _i66=-1;while(-1!==(_i66=node.data.indexOf(marker,_i66+1))){// Comment node has a binding marker inside, make an inactive part
...
if("node"===part.type){var _part8=this.processor.handleTextExpression(this.options);_part8.insertAfterNode(node.previousSibling);this.__parts.push(_part8)}else{var _this$__parts;(_this$__parts=this.__parts).push.apply(_this$__parts,babelHelpers.toConsumableArray(this.processor.handleAttributeExpressions(node,part.name,part.strings,this.options)))}partIndex++}if(isCEPolyfill){document.adoptNode(fragment);customElements.upgrade(fragment)}return fragment}}]);return TemplateInstance}();_exports.TemplateInstance$1=_exports.TemplateInstance=TemplateInstance;var templateInstance={TemplateInstance:TemplateInstance};_exports.$templateInstance=templateInstance;var TemplateResult=/*#__PURE__*/function(){function TemplateResult(strings,values,type,processor){babelHelpers.classCallCheck(this,TemplateResult);this.strings=strings;this.values=values;this.type=type;this.processor=processor}/**
     ...
     */babelHelpers.createClass(TemplateResult,[{key:"getHTML",value:function getHTML(){for(var l=this.strings.length-1,html="",isCommentBinding=!1,_i68=0;_i68<l;_i68++){var s=this.strings[_i68],commentOpen=s.lastIndexOf("<!--");// For each binding we want to determine the kind of marker to insert
...
for(var condensedStyle=document.createElement("style"),_i72=0,_style7;_i72<length;_i72++){_style7=styles[_i72];_style7.parentNode.removeChild(_style7);condensedStyle.textContent+=_style7.textContent}// Remove styles from nested templates in this scope.
...
if(firstScopeRender){var _part11=parts$1.get(renderContainer);parts$1.delete(renderContainer);if(babelHelpers.instanceof(_part11.value,TemplateInstance)){prepareTemplateStyles(renderContainer,_part11.value.template,scopeName)}removeNodes(container,container.firstChild);container.appendChild(renderContainer);parts$1.set(container,_part11)}// After elements have hit the DOM, update styling if this is the
...
styleSet.forEach(function(v){return styles.unshift(v)})}else if(userStyles){styles.push(userStyles)}return styles}}]);return LitElement}(UpdatingElement);_exports.LitElement=LitElement;/**
   ...
   */function createStore(reducer,preloadedState,enhancer){var _ref2;if("function"===typeof preloadedState&&"function"===typeof enhancer||"function"===typeof enhancer&&"function"===typeof arguments[3]){throw new Error("It looks like you are passing several store enhancers to "+"createStore(). This is not supported. Instead, compose them "+"together to a single function")}if("function"===typeof preloadedState&&"undefined"===typeof enhancer){enhancer=preloadedState;preloadedState=void 0}if("undefined"!==typeof enhancer){if("function"!==typeof enhancer){throw new Error("Expected the enhancer to be a function.")}return enhancer(createStore)(reducer,preloadedState)}if("function"!==typeof reducer){throw new Error("Expected the reducer to be a function.")}var currentReducer=reducer,currentState=preloadedState,currentListeners=[],nextListeners=currentListeners,isDispatching=!1;function ensureCanMutateNextListeners(){if(nextListeners===currentListeners){nextListeners=currentListeners.slice()}}/**
     ...
     * @returns {void}
     */function replaceReducer(nextReducer){if("function"!==typeof nextReducer){throw new Error("Expected the nextReducer to be a function.")}currentReducer=nextReducer;dispatch({type:ActionTypes.REPLACE})}/**
...
throw new Error(message)}catch(e){}// eslint-disable-line no-empty
   ...
   */function isCrushed(){}if("production"!==process.env.NODE_ENV&&"string"===typeof isCrushed.name&&"isCrushed"!==isCrushed.name){warning("You are currently using minified code outside of NODE_ENV === \"production\". "+"This means that you are running a slower development build of Redux. "+"You can use loose-envify (https://github.com/zertosh/loose-envify) for browserify "+"or setting mode to production in webpack (https://webpack.js.org/concepts/mode/) "+"to ensure you have the correct code for your production build.")}var redux={createStore:createStore,combineReducers:combineReducers,bindActionCreators:bindActionCreators,applyMiddleware:applyMiddleware,compose:compose,__DO_NOT_USE__ActionTypes:ActionTypes};/**
   ...
   Code distributed by Google as part of the polymer project is also
   subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
   */_exports.$redux=redux;var UPDATE_PAGE="UPDATE_PAGE";_exports.UPDATE_PAGE=UPDATE_PAGE;var UPDATE_OFFLINE="UPDATE_OFFLINE";_exports.UPDATE_OFFLINE=UPDATE_OFFLINE;var UPDATE_DRAWER_STATE="UPDATE_DRAWER_STATE";_exports.UPDATE_DRAWER_STATE=UPDATE_DRAWER_STATE;var OPEN_SNACKBAR="OPEN_SNACKBAR";_exports.OPEN_SNACKBAR=OPEN_SNACKBAR;var CLOSE_SNACKBAR="CLOSE_SNACKBAR";_exports.CLOSE_SNACKBAR=CLOSE_SNACKBAR;var navigate=function navigate(path){return function(dispatch){// Extract the page name from path.
var page="/"===path?"home":path.slice(1);// Any other info you might want to extract from the path (like page type),
// you can do here
dispatch(loadPage(page));// Close the drawer - in case the *path* change came from a link in the drawer.
dispatch(updateDrawerState(!1))}};_exports.navigate=navigate;var loadPage=function loadPage(page){return function(dispatch){var rootPath=/$^/,homePath=/home/,articlesPath=/articles/,articlePath=/article\/(.[^\/]+)$/,videosPath=/videos/,match,routeData=function routeData(){return 1<match.length?match.slice(1):null};if((match=page.match(homePath))||(match=page.match(rootPath))){new Promise(function(res,rej){return _require.default(["./home.component.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$homeComponent||{}});dispatch(updatePage("home",routeData()))}else if(match=page.match(articlesPath)){new Promise(function(res,rej){return _require.default(["./articles.component.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$articlesComponent||{}});dispatch(updatePage("articles",routeData()))}else if(match=page.match(articlePath)){new Promise(function(res,rej){return _require.default(["./article.component.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$articleComponent||{}});dispatch(updatePage("article",routeData()))}else if(match=page.match(videosPath)){new Promise(function(res,rej){return _require.default(["./videos.component.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$videosComponent||{}});dispatch(updatePage("videos",routeData()))}else{page="view404";new Promise(function(res,rej){return _require.default(["./my-view404.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$myView404||{}});dispatch(updatePage(page))}if(window.ga){window.ga("set","page",page)}// Scroll to the top of the screen.
window.scroll({top:0,left:0})}},updatePage=function updatePage(page,routeData){return{type:UPDATE_PAGE,page:page,routeData:routeData}},snackbarTimer,showSnackbar=function showSnackbar(){return function(dispatch){dispatch({type:OPEN_SNACKBAR});window.clearTimeout(snackbarTimer);snackbarTimer=window.setTimeout(function(){return dispatch({type:CLOSE_SNACKBAR})},3e3)}};_exports.showSnackbar=showSnackbar;var updateOffline=function updateOffline(offline){return function(dispatch,getState){// Show the snackbar only if offline status changes.
if(offline!==getState().app.offline){dispatch(showSnackbar())}dispatch({type:UPDATE_OFFLINE,offline:offline})}};_exports.updateOffline=updateOffline;var updateDrawerState=function updateDrawerState(opened){return{type:UPDATE_DRAWER_STATE,opened:opened}};_exports.updateDrawerState=updateDrawerState;var app={UPDATE_PAGE:UPDATE_PAGE,UPDATE_OFFLINE:UPDATE_OFFLINE,UPDATE_DRAWER_STATE:UPDATE_DRAWER_STATE,OPEN_SNACKBAR:OPEN_SNACKBAR,CLOSE_SNACKBAR:CLOSE_SNACKBAR,navigate:navigate,showSnackbar:showSnackbar,updateOffline:updateOffline,updateDrawerState:updateDrawerState};_exports.$app=app;var CONTENT_RECEIVED="CONTENT_RECEIVED";_exports.CONTENT_RECEIVED=CONTENT_RECEIVED;var contentReceived=function contentReceived(content){return{type:CONTENT_RECEIVED,content:content}};_exports.contentReceived=contentReceived;var contentReceived_action={CONTENT_RECEIVED:CONTENT_RECEIVED,contentReceived:contentReceived};_exports.$contentReceivedAction=contentReceived_action;var MARKDOWN_RECEIVED="MARKDOWN_RECEIVED";_exports.MARKDOWN_RECEIVED=MARKDOWN_RECEIVED;var markdownReceived=function markdownReceived(markdown){return{type:MARKDOWN_RECEIVED,markdown:markdown}};_exports.markdownReceived=markdownReceived;var markdownReceived_action={MARKDOWN_RECEIVED:MARKDOWN_RECEIVED,markdownReceived:markdownReceived};_exports.$markdownReceivedAction=markdownReceived_action;var SharedStyles=css(_templateObject5_27d9fd20813811e99f94edb206e3123b());_exports.SharedStyles=SharedStyles;var sharedStyles={SharedStyles:SharedStyles};_exports.$sharedStyles=sharedStyles;var INITIAL_STATE={page:"",offline:!1,drawerOpened:!1,snackbarOpened:!1},app$1=function app$1(){var state=0<arguments.length&&arguments[0]!==void 0?arguments[0]:INITIAL_STATE,action=1<arguments.length?arguments[1]:void 0;switch(action.type){case UPDATE_PAGE:return babelHelpers.objectSpread({},state,{page:action.page,routeData:action.routeData});case UPDATE_OFFLINE:return babelHelpers.objectSpread({},state,{offline:action.offline});case UPDATE_DRAWER_STATE:return babelHelpers.objectSpread({},state,{drawerOpened:action.opened});case OPEN_SNACKBAR:return babelHelpers.objectSpread({},state,{snackbarOpened:!0});case CLOSE_SNACKBAR:return babelHelpers.objectSpread({},state,{snackbarOpened:!1});default:return state;}};_exports.$appDefault=app$1;var app$2={default:app$1};_exports.$app$1=app$2;var INITIAL_STATE$1={articles:[],talks:[],markdown:""},content=function content(){var state=0<arguments.length&&arguments[0]!==void 0?arguments[0]:INITIAL_STATE$1,action=1<arguments.length?arguments[1]:void 0;switch(action.type){case CONTENT_RECEIVED:return babelHelpers.objectSpread({},state,action.content);case MARKDOWN_RECEIVED:return babelHelpers.objectSpread({},state,{markdown:action.markdown});default:return state;}};_exports.content=content;var content_reducer={content:content};// See https://github.com/zalmoxisus/redux-devtools-extension for more information.
_exports.$contentReducer=content_reducer;var devCompose=window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__||compose,store=createStore(function(state){return state},devCompose(lazyReducerEnhancer(combineReducers),applyMiddleware(thunk)));// Initializes the Redux store with a lazyReducerEnhancer (so that you can
// lazily add reducers after the store has been created) and redux-thunk (so
// that you can dispatch async actions). See the "Redux and state management"
// section of the wiki for more details:
// https://github.com/Polymer/pwa-starter-kit/wiki/4.-Redux-and-state-management
_exports.store=store;// Initially loaded reducers.
store.addReducers({app:app$1,content:content});var store$1={store:store};_exports.$store=store$1;var menuIcon=html$1(_templateObject6_27d9fd20813811e99f94edb206e3123b());_exports.menuIcon=menuIcon;var addToCartIcon=html$1(_templateObject7_27d9fd20813811e99f94edb206e3123b());_exports.addToCartIcon=addToCartIcon;var removeFromCartIcon=html$1(_templateObject8_27d9fd20813811e99f94edb206e3123b());_exports.removeFromCartIcon=removeFromCartIcon;var minusIcon=html$1(_templateObject9_27d9fd20813811e99f94edb206e3123b());_exports.minusIcon=minusIcon;var plusIcon=html$1(_templateObject10_27d9fd20813811e99f94edb206e3123b());_exports.plusIcon=plusIcon;var myIcons={menuIcon:menuIcon,addToCartIcon:addToCartIcon,removeFromCartIcon:removeFromCartIcon,minusIcon:minusIcon,plusIcon:plusIcon};_exports.$myIcons=myIcons;var styles=css(_templateObject11_27d9fd20813811e99f94edb206e3123b()),MenuBar=/*#__PURE__*/function(_connect){babelHelpers.inherits(MenuBar,_connect);function MenuBar(){babelHelpers.classCallCheck(this,MenuBar);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(MenuBar).apply(this,arguments))}babelHelpers.createClass(MenuBar,[{key:"menuButtonClicked",value:function menuButtonClicked(){store.dispatch(updateDrawerState(!0))}},{key:"drawerOpenedChanged",value:function drawerOpenedChanged(e){store.dispatch(updateDrawerState(e.target.opened))}},{key:"render",value:function render(){return html$1(_templateObject12_27d9fd20813811e99f94edb206e3123b(),"home"===this.selected,"articles"===this.selected||"article"===this._page,"videos"===this.selected,this.menuButtonClicked,menuIcon,this.drawerOpened,this.drawerOpenedChanged,"home"===this.selected,"articles"===this.selected||"article"===this._page,"videos"===this.selected)}},{key:"stateChanged",value:function stateChanged(state){this.drawerOpened=state.app.drawerOpened;switch(state.app.page){case"articles":case"article":this.selected="articles";break;case"videos":this.selected="videos";break;default:this.selected=state.app.page;}}}],[{key:"styles",get:function get(){return[SharedStyles,styles]}},{key:"properties",get:function get(){return{selected:{type:String},drawerOpened:{type:Boolean}}}}]);return MenuBar}(connect(store)(LitElement));window.customElements.define("m-menu-bar",MenuBar);var SnackBar=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(SnackBar,_LitElement);function SnackBar(){babelHelpers.classCallCheck(this,SnackBar);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SnackBar).apply(this,arguments))}babelHelpers.createClass(SnackBar,[{key:"render",value:function render(){return html$1(_templateObject13_27d9fd20813811e99f94edb206e3123b())}}],[{key:"properties",get:function get(){return{active:{type:Boolean}}}},{key:"styles",get:function get(){return[css(_templateObject14_27d9fd20813811e99f94edb206e3123b())]}}]);return SnackBar}(LitElement);window.customElements.define("snack-bar",SnackBar);var getContent=function getContent(){return fetch("content/index.json").then(function(response){return response.json()}).then(function(content){return store.dispatch(contentReceived(content))})};_exports.getContent=getContent;var getMarkdown=function getMarkdown(path){fetch("".concat(path)).then(function(response){return response.blob()}).then(function(blob){var reader=new FileReader;reader.readAsText(blob);reader.onload=function(e){return store.dispatch(markdownReceived(e.target.result))}})};_exports.getMarkdown=getMarkdown;var content_service={getContent:getContent,getMarkdown:getMarkdown};_exports.$contentService=content_service;var MyApp=/*#__PURE__*/function(_connect2){babelHelpers.inherits(MyApp,_connect2);babelHelpers.createClass(MyApp,[{key:"renderCurrentPage",value:function renderCurrentPage(){switch(this._page){case"home":return html$1(_templateObject15_27d9fd20813811e99f94edb206e3123b());case"articles":return html$1(_templateObject16_27d9fd20813811e99f94edb206e3123b());case"article":return html$1(_templateObject17_27d9fd20813811e99f94edb206e3123b());case"videos":return html$1(_templateObject18_27d9fd20813811e99f94edb206e3123b());default:return html$1(_templateObject19_27d9fd20813811e99f94edb206e3123b());}}},{key:"render",value:function render(){// Anything that's related to rendering should be done in here.
return html$1(_templateObject20_27d9fd20813811e99f94edb206e3123b(),this.renderCurrentPage(),this._snackbarOpened,this._offline?"offline":"online")}}],[{key:"properties",get:function get(){return{appTitle:{type:String},_page:{type:String},_drawerOpened:{type:Boolean},_snackbarOpened:{type:Boolean},_offline:{type:Boolean}}}},{key:"styles",get:function get(){return[css(_templateObject21_27d9fd20813811e99f94edb206e3123b())]}}]);function MyApp(){var _this45;babelHelpers.classCallCheck(this,MyApp);_this45=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(MyApp).call(this));// To force all event listeners for gestures to be passive.
// See https://www.polymer-project.org/3.0/docs/devguide/settings#setting-passive-touch-gestures
setPassiveTouchGestures(!0);getContent();return _this45}babelHelpers.createClass(MyApp,[{key:"firstUpdated",value:function firstUpdated(){installRouter(function(location){return store.dispatch(navigate(decodeURIComponent(location.pathname)))});installOfflineWatcher(function(offline){return store.dispatch(updateOffline(offline))});installMediaQueryWatcher("(min-width: 460px)",function(){return store.dispatch(updateDrawerState(!1))})}},{key:"updated",value:function updated(changedProps){if(changedProps.has("_page")){var pageTitle=this._page+" // mikerambl.es";updateMetadata({title:pageTitle,description:pageTitle// This object also takes an image property, that points to an img src.
})}}},{key:"_menuButtonClicked",value:function _menuButtonClicked(){store.dispatch(updateDrawerState(!0))}},{key:"_drawerOpenedChanged",value:function _drawerOpenedChanged(e){store.dispatch(updateDrawerState(e.target.opened))}},{key:"stateChanged",value:function stateChanged(state){this._page=state.app.page;this._offline=state.app.offline;this._snackbarOpened=state.app.snackbarOpened;this._drawerOpened=state.app.drawerOpened}}]);return MyApp}(connect(store)(LitElement));window.customElements.define("my-app",MyApp);var PageViewElement=/*#__PURE__*/function(_LitElement2){babelHelpers.inherits(PageViewElement,_LitElement2);function PageViewElement(){babelHelpers.classCallCheck(this,PageViewElement);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PageViewElement).apply(this,arguments))}babelHelpers.createClass(PageViewElement,[{key:"shouldUpdate",// Only render this page if it's actually visible.
value:function shouldUpdate(){return this.active}}],[{key:"properties",get:function get(){return{active:{type:Boolean}}}}]);return PageViewElement}(LitElement);_exports.PageViewElement=PageViewElement;var pageViewElement={PageViewElement:PageViewElement};_exports.$pageViewElement=pageViewElement});