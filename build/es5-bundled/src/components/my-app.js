...
if(30<Math.abs(this._initScrollTop-scrollTop)||10<absDScrollTop){if(isScrollingDown&&scrollTop>=maxHeaderTop){top=maxHeaderTop}else if(!isScrollingDown&&scrollTop>=this._dHeight){top=this.condenses&&!this.fixed?this._dHeight:0}var scrollVelocity=dScrollTop/(now-this._lastTimestamp);this.style.transitionDuration=this._clamp((top-lastTop)/scrollVelocity,0,300)+"ms"}else{top=this._top}}}if(0===this._dHeight){progress=0<scrollTop?1:0}else{progress=top/this._dHeight}if(!forceUpdate){this._lastScrollTop=scrollTop;this._top=top;this._wasScrollingDown=isScrollingDown;this._lastTimestamp=now}if(forceUpdate||progress!==this._progress||lastTop!==top||0===scrollTop){this._progress=progress;this._runEffects(progress,top);this._transformHeader(top)}},/**
   ...
   */run:function run(){this.shadow=this.isOnScreen()&&this.isContentBelow()}});Polymer({_template:html(_templateObject4_7f479d00812a11e9aac75b1ceaff2413()),is:"app-toolbar"});/**
    @license
...
store.addReducers({app:app$1,content:content});var store$1={store:store};_exports.$store=store$1;var menuIcon=html$1(_templateObject6_7f479d00812a11e9aac75b1ceaff2413());_exports.menuIcon=menuIcon;var addToCartIcon=html$1(_templateObject7_7f479d00812a11e9aac75b1ceaff2413());_exports.addToCartIcon=addToCartIcon;var removeFromCartIcon=html$1(_templateObject8_7f479d00812a11e9aac75b1ceaff2413());_exports.removeFromCartIcon=removeFromCartIcon;var minusIcon=html$1(_templateObject9_7f479d00812a11e9aac75b1ceaff2413());_exports.minusIcon=minusIcon;var plusIcon=html$1(_templateObject10_7f479d00812a11e9aac75b1ceaff2413());_exports.plusIcon=plusIcon;var myIcons={menuIcon:menuIcon,addToCartIcon:addToCartIcon,removeFromCartIcon:removeFromCartIcon,minusIcon:minusIcon,plusIcon:plusIcon};_exports.$myIcons=myIcons;var styles=css(_templateObject11_7f479d00812a11e9aac75b1ceaff2413()),MenuBar=/*#__PURE__*/function(_connect){babelHelpers.inherits(MenuBar,_connect);function MenuBar(){babelHelpers.classCallCheck(this,MenuBar);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(MenuBar).apply(this,arguments))}babelHelpers.createClass(MenuBar,[{key:"menuButtonClicked",value:function menuButtonClicked(){store.dispatch(updateDrawerState(!0))}},{key:"drawerOpenedChanged",value:function drawerOpenedChanged(e){store.dispatch(updateDrawerState(e.target.opened))}},{key:"render",value:function render(){return html$1(_templateObject12_7f479d00812a11e9aac75b1ceaff2413(),"home"===this.selected,"articles"===this.selected||"article"===this._page,"view3"===this.selected,this.menuButtonClicked,menuIcon,this.drawerOpened,this.drawerOpenedChanged,"home"===this.selected,"articles"===this.selected||"article"===this._page,"view3"===this.selected)}},{key:"stateChanged",value:function stateChanged(state){this.drawerOpened=state.app.drawerOpened;switch(state.app.page){case"articles":case"article":this.selected="articles";break;default:this.selected=state.app.page;}}}],[{key:"styles",get:function get(){return[SharedStyles,styles]}},{key:"properties",get:function get(){return{selected:{type:String},drawerOpened:{type:Boolean}}}}]);return MenuBar}(connect(store)(LitElement));window.customElements.define("m-menu-bar",MenuBar);var SnackBar=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(SnackBar,_LitElement);function SnackBar(){babelHelpers.classCallCheck(this,SnackBar);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SnackBar).apply(this,arguments))}babelHelpers.createClass(SnackBar,[{key:"render",value:function render(){return html$1(_templateObject13_7f479d00812a11e9aac75b1ceaff2413())}}],[{key:"properties",get:function get(){return{active:{type:Boolean}}}},{key:"styles",get:function get(){return[css(_templateObject14_7f479d00812a11e9aac75b1ceaff2413())]}}]);return SnackBar}(LitElement);window.customElements.define("snack-bar",SnackBar);var getContent=function getContent(){return fetch("content/index.json").then(function(response){return response.json()}).then(function(content){return store.dispatch(contentReceived(content))})};_exports.getContent=getContent;var getMarkdown=function getMarkdown(path){fetch("".concat(path)).then(function(response){return response.blob()}).then(function(blob){var reader=new FileReader;reader.readAsText(blob);reader.onload=function(e){return store.dispatch(markdownReceived(e.target.result))}})};_exports.getMarkdown=getMarkdown;var content_service={getContent:getContent,getMarkdown:getMarkdown};_exports.$contentService=content_service;var MyApp=/*#__PURE__*/function(_connect2){babelHelpers.inherits(MyApp,_connect2);babelHelpers.createClass(MyApp,[{key:"renderCurrentPage",value:function renderCurrentPage(){switch(this._page){case"home":return html$1(_templateObject15_7f479d00812a11e9aac75b1ceaff2413());case"articles":return html$1(_templateObject16_7f479d00812a11e9aac75b1ceaff2413());case"article":return html$1(_templateObject17_7f479d00812a11e9aac75b1ceaff2413());default:return html$1(_templateObject18_7f479d00812a11e9aac75b1ceaff2413());}}},{key:"render",value:function render(){// Anything that's related to rendering should be done in here.
return html$1(_templateObject19_7f479d00812a11e9aac75b1ceaff2413(),this.renderCurrentPage(),this._snackbarOpened,this._offline?"offline":"online")}}],[{key:"properties",get:function get(){return{appTitle:{type:String},_page:{type:String},_drawerOpened:{type:Boolean},_snackbarOpened:{type:Boolean},_offline:{type:Boolean}}}},{key:"styles",get:function get(){return[css(_templateObject20_7f479d00812a11e9aac75b1ceaff2413())]}}]);function MyApp(){var _this45;babelHelpers.classCallCheck(this,MyApp);_this45=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(MyApp).call(this));// To force all event listeners for gestures to be passive.
