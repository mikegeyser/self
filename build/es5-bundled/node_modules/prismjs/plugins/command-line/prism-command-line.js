...
pre.className+=" command-line"}var getAttribute=function getAttribute(key,defaultValue){return(pre.getAttribute(key)||defaultValue).replace(/"/g,"&quot")},promptLines=Array(commandLine.numberOfLines+1),promptText=getAttribute("data-prompt","");// Create the "rows" that will become the command-line prompts. -- cwells
