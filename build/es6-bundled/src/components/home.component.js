define(["exports","./my-app.js"],function(_exports,_myApp){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.profilePicture=_exports.$svgPictures=void 0;const profilePicture=_myApp.svg`
...
`;_exports.profilePicture=profilePicture;var svgPictures={profilePicture:profilePicture};_exports.$svgPictures=svgPictures;const styles=_myApp.css`
  .profile-picture {
    height: 25vw;
    width: 25vw;
    overflow: hidden;
...
`;class Home extends _myApp.PageViewElement{static get styles(){return[_myApp.SharedStyles,styles]}render(){return _myApp.html`
      <section>
        <div class="container">
